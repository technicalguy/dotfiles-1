...
NeoBundle 'thisivan/vim-ruby-matchit'
...
NeoBundleLazy 'tpope/vim-rails', {'augroup': 'railsPluginDetect', 'autoload': {'commands': [{'complete': 'customlist,s:Complete_environments', 'name': 'Rlog'}, {'complete': 'customlist,s:Complete_generate', 'name': 'Generate'}, 'Rset', {'complete': 'customlist,rails#complete_rake', 'name': 'Rake'}, {'complete': 'customlist,s:Complete_server', 'name': 'Rserver'}, {'complete': 'customlist,s:Complete_ruby', 'name': 'Rpp'}, 'Rextract', {'complete': 'customlist,s:Complete_related', 'name': 'A'}, {'complete': 'customlist,s:Complete_cd', 'name': 'Rlcd'}, {'complete': 'customlist,s:Complete_related', 'name': 'R'}, 'Extract', {'complete': 'customlist,s:Complete_environments', 'name': 'Rdbext'}, {'complete': 'customlist,s:Complete_environments', 'name': 'Console'}, {'complete': 'customlist,s:Complete_preview', 'name': 'Rbrowse'}, 'Rnavcommand', 'Ctags', {'complete': 'customlist,s:Complete_script', 'name': 'Rscript'}, {'complete': 'customlist,s:Complete_related', 'name': 'RD'}, {'complete': 'customlist,s:Complete_related', 'name': 'RE'}, 'Rabbrev', 'Rtags', {'complete': 'customlist,s:Complete_related', 'name': 'RS'}, {'complete': 'customlist,s:Complete_related', 'name': 'RT'}, {'complete': 'customlist,s:Complete_related', 'name': 'RV'}, {'complete': 'customlist,s:Complete_preview', 'name': 'Rpreview'}, {'complete': 'customlist,s:Complete_server', 'name': 'Server'}, {'complete': 'customlist,rails#complete_rails', 'name': 'Rails'}, {'complete': 'customlist,s:Complete_generate', 'name': 'Rgenerate'}, {'complete': 'customlist,s:Complete_destroy', 'name': 'Rdestroy'}, 'Rrefresh', {'complete': 'customlist,s:Complete_ruby', 'name': 'Rp'}, {'complete': 'customlist,s:Complete_cd', 'name': 'Cd'}, {'complete': 'customlist,s:Complete_edit', 'name': 'Runner'}, {'complete': 'customlist,s:Complete_cd', 'name': 'Lcd'}, {'complete': 'customlist,s:Complete_edit', 'name': 'Rrunner'}, {'complete': 'customlist,s:Complete_related', 'name': 'AD'}, {'complete': 'customlist,s:Complete_related', 'name': 'AE'}, {'complete': 'customlist,s:Complete_preview', 'name': 'Preview'}, 'OpenURL', {'complete': 'customlist,s:Complete_cd', 'name': 'Rcd'}, 'Rinvert', {'complete': 'customlist,s:Complete_related', 'name': 'AR'}, {'complete': 'customlist,s:Complete_related', 'name': 'AS'}, {'complete': 'customlist,s:Complete_related', 'name': 'AT'}, {'complete': 'customlist,s:Complete_destroy', 'name': 'Destroy'}, {'complete': 'customlist,s:Complete_related', 'name': 'AV'}]}}
