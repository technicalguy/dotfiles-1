...
" PATHの設定
if has('gui_running')
  let $PATH = '/usr/local/Cellar/ruby/1.9.3-p194/bin:/usr/local/sbin:/usr/local/bin:/usr/local/share/npm/bin:' . $PATH
endif
...
autocmd FileType javascript setlocal omnifunc=omnifunc=jscomplete#CompleteJS
