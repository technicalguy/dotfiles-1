...
#export
export PATH=/Library/TeX/texbin/:${HOME}/local/bin:${HOME}/.composer/vendor/bin:${HOME}/.local/bin:/usr/local/opt/go/libexec/bin:$GOPATH/bin:$HOME/.cabal/bin:/usr/local/sbin:/usr/local/bin:$PATH
